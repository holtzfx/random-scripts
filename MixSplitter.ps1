...
## Make sure the input file is inside the mp3 folder.
$inputFile = "Terminus _ Techstep + Drum and Bass Mix.mp3"
...
## Summon ffmpeg and pass all the relevant parameters.
	./ffmpeg -i "mp3/$inputFile" -metadata TPE1="$songArtist" -metadata TIT2="$songTitle" -metadata TRCK="$songCounter" -ss $songStart -to $songEnd -c copy "mp3/$songArtist - $songTitle.mp3"
